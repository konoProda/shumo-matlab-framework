...
\noindent 其中 \(P_{d,t}\) 为 0:00 原始计划，\(A^s_{d,t}\)（\(s\in\{6,12,18\}\)）为各阶段重新优化后的计划，\(B_{d,t}\) 为将各阶段真实生效区间拼接后的最终全天计划，\(\Delta^+,\Delta^-\) 为最终计划相对 0:00 原计划的调增量与调减量。
