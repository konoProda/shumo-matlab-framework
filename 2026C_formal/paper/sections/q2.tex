...
全天计划购电费用为 \(13\,149\,064.98\ \mathrm{元}\)， 紧急购电费用为 \(1\,657\,825.30\ \mathrm{元}\)， 总购电费用为
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.78\textwidth]{figures/q2_year.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.78\textwidth]{figures/q2_soc.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.78\textwidth]{figures/q2_keydate.png}
\caption{问题二四个指定日期的计划购电与紧急购电（电量单位：kWh）}
\label{fig:q2-key}
\end{figure}

四天中仅 09-23 触发紧急购电（5\,351.69 kWh，分 08:20—10:00 与 19:50—22:00 两段），其余三天均为零，与表~\ref{tab:7} 的逐日指标一致。
%FIG:END q2-key
