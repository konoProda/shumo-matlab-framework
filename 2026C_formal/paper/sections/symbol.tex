...
\multicolumn{3}{l}{\textit{（三）由输入数据预构造的辅助量}} \\
\(PV^{L}_{d,t}\) & 光伏直接供负荷功率，\(PV^{L}_{d,t}=\min(PV_{d,t},L_{d,t})\) & kW \\
\(\overline L_{d,t}\) & 光伏供电后的负荷缺口，\(\overline L_{d,t}=\max(L_{d,t}-PV_{d,t},0)\) & kW \\
\(\overline{PV}_{d,t}\) & 满足负荷后的富余光伏，\(\overline{PV}_{d,t}=\max(PV_{d,t}-L_{d,t},0)\) & kW \\
