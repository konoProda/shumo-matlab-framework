...
\begin{center}{\heiti\zihao{4}问题二：四个指定日期的结果（题目表 1、表 2、表 3 格式）}\end{center}
...
\hline
\end{tabular}
\par\vspace{2pt}{\zihao{6}表 1（2025.3.20）　问题二}
...
\hline
\end{tabular}
\par\vspace{2pt}{\zihao{6}表 1（2025.6.21）　问题二}
...
\hline
\end{tabular}
\par\vspace{2pt}{\zihao{6}表 1（2025.9.23）　问题二}
...
\hline
\end{tabular}
\par\vspace{2pt}{\zihao{6}表 1（2025.12.21）　问题二}
...
\hline
\end{tabular}
\par\vspace{2pt}{\zihao{6}表 2（2025.3.20）　问题二}
...
\hline
\end{tabular}
\par\vspace{2pt}{\zihao{6}表 2（2025.6.21）　问题二}
...
\hline
\end{tabular}
\par\vspace{2pt}{\zihao{6}表 2（2025.9.23）　问题二}
...
\hline
\end{tabular}
\par\vspace{2pt}{\zihao{6}表 2（2025.12.21）　问题二}
...
\hline
\end{tabular}
\par\vspace{2pt}{\zihao{6}微网在指定日期的紧急购电量（问题二）}
